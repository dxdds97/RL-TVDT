...
short_prediction_model_path = 'Transformer/pretrained/sp_100/short/checkpoint.pth'
long_prediction_model_path = 'Transformer/pretrained/sp_100/long/checkpoint.pth'
mae_model_path = 'Transformer/pretrained/sp_100/mae/checkpoint.pth'
full_stock_dir = '../data/SP/'
ticker_list = config.use_ticker_dict['SP']
prediction_len = [1,5]
...
# train = data_split(df, '2017-11-01','2021-07-10')
# eval = data_split(df, '2021-07-10', '2021-12-31')
# test = data_split(df,'2018-10-09', '2021-05-01')
...
model_path = os.path.join('trained_models/', version, model_name, 'model30000.zip')  # model30000
start = time.time()
...
assets_his, df_actions, drawdowns, accumulated_return, calmar = results[1], results[2],results[3], results[4], results[5]
df_actions.to_csv(df_root+'df_actions_test.csv')
assets_his.to_csv(df_root+'df_assets_his_test.csv')
drawdowns.to_csv(df_root+'df_drawdowns_his_test.csv')
accumulated_return.to_csv(df_root+'df_accumulate_return_his_test.csv')
calmar.to_csv(df_root+'df_calmar_ratio_test.csv')
