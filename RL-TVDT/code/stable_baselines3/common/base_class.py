...
class BaseAlgorithm(ABC):
    ...
    :param env: The environment to learn from
                (if registered in Gym, can be str. Can be None for loading trainedmodels)
    ...
    def __init__(
        ...
        if env is not None:
            ...
            if not support_multi_env and self.n_envs > 1:
                raise ValueError(
                    "Error: the TVDT does not support multiple envs; it requires " "a single vectorized environment."
                )
    ...
    def predict(
        ...
        """
        Get themodels's action(s) from an observation

        :param observation: the input observation
        :param state: The last states (can be None, used in recurrent policies)
        :param mask: The last masks (can be None, used in recurrent policies)
        :param deterministic: Whether or not to return deterministic actions.
        :return: themodels's action and the next state
    ...
    def load(
        ...
        **kwargs,
        ...
        :param print_system_info: Whether to print system info from the savedmodels
