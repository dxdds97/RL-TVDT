...
class RolloutBuffer(BaseBuffer):
    ...
    The term rollout here refers to the TVDT-free notion and should not
    be used with the concept of rollout used inmodels-based RL or planning.
...
class DictRolloutBuffer(RolloutBuffer):
    ...
    The term rollout here refers to themodels-free notion and should not
    be used with the concept of rollout used inmodels-based RL or planning.
    Hence, it is only involved in policy and value function training but not action selection.
