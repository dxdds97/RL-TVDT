...
class BaseModel(nn.Module, ABC):
    """
    The base TVDT object: makes predictions in response to observations.
    ...
    def _get_constructor_parameters(self) -> Dict[str, Any]:
        """
        Get data that need to be saved in order to re-create the TVDT when loading it from disk.

        :return: The dictionary to pass to the as kwargs constructor when reconstruction this TVDT.
        """
        return dict(
    ...
    def save(self, path: str) -> None:
        """
        Savemodels to a given location.
    ...
    def obs_to_tensor(self, observation: Union[np.ndarray, Dict[str, np.ndarray]]) -> Tuple[th.Tensor, bool]:
        """
        Convert an input observation to a PyTorch tensor that can be fed to amodels.
