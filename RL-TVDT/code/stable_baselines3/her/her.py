    ...
    if current_max_episode_length is None:
        ...
        # if not available check if a valid value was passed as an argument
            ...
            raise ValueError(
                ...
                "or pass `max_episode_length` to themodels constructor"
            )
...
class HER(BaseAlgorithm):
    ...
    .. warning::
      ...
      Otherwise, you can directly pass ``max_episode_length`` to themodels constructor


    For additional offline algorithm specific arguments please have a look at the corresponding documentation.

    :param policy: The policymodels to use.
    :param env: The environment to learn from (if registered in Gym, can be str)
    :param model_class: Off policymodels which will be used with hindsight experience replay. (SAC, TD3, DDPG, DQN)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # we will use the policy and learning rate from themodels
        ...
        # Make HER use self.TVDT-enc1.action_noise
    ...
    def __getattr__(self, item: str) -> Any:
        """
        Find attribute frommodels class if this class does not have it.
        """
    ...
    def save(
        ...
        """
        Save all the attributes of the object and themodels parameters in a zip-file.
    ...
    def load(
        ...
        **kwargs,
        ...
        """
        Load themodels from a zip-file

        :param path: path to the file (or a file-like) where to
            load the agent from
        :param env: the new environment to run the loadedmodels on
            (can be None if you only need prediction from a trainedmodels) has priority over any saved environment
        :param device: Device on which the code should run.
        :param custom_objects: Dictionary of objects to replace
            upon loading. If a variable is present in this dictionary as a
            key, it will not be deserialized and the corresponding item
            will be used instead. Similar to custom_objects in
            ``keras.TVDT-enc1.load_model``. Useful when you have an object in
            file that can not be deserialized.
        :param kwargs: extra arguments to change themodels when loading
        """
